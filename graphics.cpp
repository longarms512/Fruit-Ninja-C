...
void draw_explosion(boundingBox b) {
    uLCD.filled_rectangle(b.topLeft.x, b.topLeft.y, b.topLeft.x+3, b.topLeft.y+3, YELLOW);
    uLCD.filled_rectangle(b.topLeft.x, b.topLeft.y+7, b.topLeft.x+3, b.topLeft.y+10, YELLOW);
    uLCD.filled_rectangle(b.topLeft.x+7, b.topLeft.y, b.topLeft.x+10, b.topLeft.y+3, YELLOW);
    uLCD.filled_rectangle(b.topLeft.x+7, b.topLeft.y+7, b.topLeft.x+10, b.topLeft.y+10, YELLOW);
